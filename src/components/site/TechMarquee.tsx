  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" className="size-full" aria-hidden>
        ...
        <path
          fill="#fff"
          d="M14.4 24c0-2.5 1-4.8 2.7-6.5l6.3 16.7c-3.4-.9-6.3-3.3-7.7-6.5-.8-1.8-1.3-3.7-1.3-5.7zm19.2 1.3c0 2.3-.8 4-1.6 5.3-.9 1.5-1.9 2.7-3.6 2.7-1.6 0-2.6-1-2.6-2.8 0-2.8 2-6.2 2.9-8.4.4-.9.6-1.6.6-2.3 0-1.4-.9-2.3-2.3-2.3-1.5 0-2.8.8-3.8 1.7l.7-2.8c1.4-1.1 3.2-1.8 5.1-1.8 3.2 0 5.3 1.9 5.3 5.3 0 1.2-.3 2.4-.7 3.6l-1.2 4.1c-.3 1-.5 1.8-.5 2.5 0 .9.4 1.4 1.2 1.4 1.2 0 2.5-1.8 3.1-3.5.2-.6.4-1.2.4-1.8v-.8zm-8.3-9.1c.7-.8 1.2-1.9 1.2-3 0-1.4-.6-2.7-1.7-3.6 1 .2 1.9.7 2.6 1.5.7.8 1.1 1.9 1.1 3 0 1.1-.4 2.1-1.1 3-.7.8-1.6 1.3-2.6 1.5 1.1-.9 1.7-2.2 1.7-3.6-.1-1.1-.5-2.2-1.2-3zM24 8.5c-8.5 0-15.5 7-15.5 15.5S15.5 39.5 24 39.5 39.5 32.5 39.5 24 32.5 8.5 24 8.5zm-13 15.5c0-3.8 1.8-7.2 4.6-9.4l6.4 17.5c-2.8 1.4-6 1.8-9 1-1-.3-1.9-.7-2.8-1.2-1.3-2.3-2.2-5-2.2-7.9zm13 13c-.6 0-1.2 0-1.8-.1l6.8-19.7 2.2 6c.1.3.2.6.2.9 0 3.6-2.9 6.5-6.5 6.5-.3 0-.6 0-.9-.1v6.5zm6.4-20.4l.7-2.1c.2-.6.3-1.1.3-1.6 0-1.3-.6-2.4-1.7-3.1 2.1.8 3.6 2.9 3.6 5.3 0 .6-.1 1.2-.3 1.8l-.6 1.7z"
        />
      </svg>
    ),
  },
