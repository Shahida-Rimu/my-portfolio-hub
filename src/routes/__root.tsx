...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shahida Akter Rimu — UI/UX Designer & Frontend Developer" },
      {
        name: "description",
        content:
          "Portfolio of Shahida Akter Rimu, UI/UX designer and frontend developer building intuitive, accessible digital experiences.",
      },
      { name: "author", content: "Shahida Akter Rimu" },
